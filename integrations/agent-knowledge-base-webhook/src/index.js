/**
 * agent-knowledge-base-webhook - Integration: webhook for Intelligent Knowledge Base
 * Project: agent-knowledge-base
 */
export class AgentKnowledgeBaseWebhook {
  constructor(options = {}) {
    this.name = 'agent-knowledge-base-webhook';
...
export default AgentKnowledgeBaseWebhook;
